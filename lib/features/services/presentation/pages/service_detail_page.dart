                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Booking placed for ${_fmtDate(selectedDate)} at ${_fmtTime(selectedTime)}',
                          ),
                          behavior: SnackBarBehavior.floating,
...
class _BookingSheetRow extends StatelessWidget {
  final IconData icon;
  final String label;
  final String value;
  const _BookingSheetRow({
    required this.icon,
    required this.label,
    required this.value,
  });
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  service.pricingModel == PricingModel.hourly
                      ? 'per hour'
                      : service.pricingModel == PricingModel.package
                      ? 'per package'
                      : 'fixed price',
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: service.isActive
                  ? () => _showBookingSheet(context, ref, service)
                  : null,
              style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.primary,
